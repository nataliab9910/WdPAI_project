...
Routing::get('timetable', 'LessonController', Routing::ROLE_USER);
...
Routing::get('deleteLesson', 'LessonController', Routing::ROLE_USER);
...
Routing::post('addLesson', 'LessonController', Routing::ROLE_USER);
